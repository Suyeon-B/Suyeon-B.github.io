(function () {
  function displayPost(post) {
    ...
    appendString +=
      '<a href="' +
      post.url.substring(0, 4) +
      "/" +
      post.url.substring(4, 6) +
      "/" +
      post.url.substring(6, 8) +
      "/" +
      post.url.substring(8) +
      '">';
  ...
  if (searchTerm) {
    document.querySelectorAll('[name="query"]').forEach((searchBox) => searchBox.setAttribute("value", searchTerm));
